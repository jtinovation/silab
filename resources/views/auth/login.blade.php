                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input tabindex="10" type="text" class="form-control" id="username"
                                                placeholder="tuladha@gmail.com" name="email" value="{{ old('email') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input tabindex="11" type="password" class="form-control pe-5"
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> JTI Polije. Develop By Lab KSI & RPL. Crafted with <i
