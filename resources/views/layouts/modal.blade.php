                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="wrap-bahan-to-lab">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 mt-4">
                                    <button type="button" id="btnBahanLab" class="ol-xxl-12 col-xl-12 col-lg-12 col-md-12 btn btn-primary waves-effect waves-light ">Tambah Bahan Laboratorium</button>
                                </div>
                            </div>
                        </div>
                        <div class="wrap-master-alat" style="display: none;">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 row d-flex mt-2">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <button type="button" id="btnMasterAlat" class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 btn btn-primary waves-effect waves-light ">Tambah Data Bahan</button>
                                    </div>
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <button type="button" id="btnCancel" class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 btn btn-primary waves-effect waves-light ">Batal Input Data</button>
                                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="color: black;">Detail Data Role</h4>
                </div>
...
@if($data['npage'] ==0)
    ...
    <!-- modal start -->
    <div class="modal fade" id="showDetailBarang" tabindex="-1" role="dialog" aria-labelledby="ultraModal-Label" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="color: black;">Detail Data Barang Laboratorium</h4>
                </div>
                <div class="modal-body" style="color: white;">
                    <div id="test"></div>
                </div>
