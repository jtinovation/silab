                    ...
                    <div class="row g-3">
                        <div class="col-lg-4">
                            ...
                            <div class="col-12 gy-4">
                                <div>
                                    <div class="col-12 btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" name="is_aktif" id="is_aktif1" value="1" autocomplete="off" @if($pegawai->is_aktif == 1) checked @endif>
                                        <label class="btn btn-outline-primary" for="is_aktif1">&nbsp;&nbsp;&nbsp;&nbsp;Aktif&nbsp;&nbsp;&nbsp;</label>

                                        <input type="radio" class="btn-check" name="is_aktif" id="is_aktif2" value="0" autocomplete="off" @if($pegawai->is_aktif == 0) checked @endif>
                            ...
                            <div class="col-12 gy-4">
                                <div>
                                    <div class="col-12 btn-group" role="group" aria-label="Basic radio toggle button group">
                                        <input type="radio" class="btn-check" name="tm_status_kepegawaian_id" id="tm_status_kepegawaian_id1" value="1" autocomplete="off" @if($pegawai->tm_status_kepegawaian_id == 1) checked @endif>
                                        <label class="btn btn-outline-success" for="tm_status_kepegawaian_id1">Dosen</label>

                                        <input type="radio" class="btn-check" name="tm_status_kepegawaian_id" id="tm_status_kepegawaian_id2" value="2" autocomplete="off" @if($pegawai->tm_status_kepegawaian_id == 2) checked @endif>
                                        <label class="btn btn-outline-warning" for="tm_status_kepegawaian_id2">Administrasi</label>

                                        <input type="radio" class="btn-check" name="tm_status_kepegawaian_id" id="tm_status_kepegawaian_id3" value="3" autocomplete="off" @if($pegawai->tm_status_kepegawaian_id == 3) checked @endif>
