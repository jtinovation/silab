                        ...
                        <div class="row g-3">
                            <form action="" class="form-horizontal" id="frmJurusan" method="post" enctype="multipart/form-data" data-parsley-validate="">
                                ...
                                <div class="row d-flex justify-content-center">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            <label for="SelectKaJur" class="form-label text-right">Pilih Ka. Jurusan</label></br>
                ...
                <div class="card-body ">
                    <form action="" class="form-horizontal" id="frmProdi" method="post" enctype="multipart/form-data" data-parsley-validate="">
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-xxl-4 col-md-4">
                                        <div>
                                            <label for="SelectKaprodi" class="form-label text-right">Pilih Ka. Program Studi</label></br>
...
<script type="text/javascript">
    var idjur       = "";
    var kajurid     = "";
    var urlProdi    = "{{ route('getProdi', 0) }}";
    var url         = "{{ route('getProdi', 0) }}";
