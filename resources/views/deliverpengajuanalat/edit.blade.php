    ...
    <div class="row col-md-12 col-lg-12 col-sm-12 animate__animated animate__backInLeft">
            <div class="card go">
                <div class="card-body ">
                    ...
                    <form action="{{route('deljulat.update',$qrUsulan[0]->id)}}" class="form-horizontal" id="frmPengajuanAlat" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12 mt-3">
                                <div>
                                    ...
                                    <select class="form-control" style="font-size: 15px;" name="tm_laboratorium_id" id="selectLab" required>
                                        <option></option>
                                        @foreach($data['lab'] as $v)
                                            <option value="{{$v->id}}" {{$v->id == $qrUsulan[0]->tm_laboratorium_id ? 'selected' : ''}}>{{$v->laboratorium}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 ">
                                ...
                                <div class="wrapper">
                                    <div class="row form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 wrap" id="{{"inputCopy-".$vdu->id}}" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2">
                                            <input class="form-control number" type="text" name="{{'acc-'.$vdu->id}}" value="{{$vdu->keb_acc?$vdu->keb_acc:0}}" style="padding: 8px 10px;" >
                                    </div>
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="col-md-12 row button-items justify-content-center gap-3" style="margin-top: 10px;">
                                <button type="submit" id="btnSubmit" class="col-xxl-4 col-md-4 btn btn-primary waves-effect waves-light ">Deliver Kebutuhan Bahan Praktikum</button>
                                <button type="button" id="btnCancel" class="col-xxl-4 col-md-4 btn btn-secondary waves-effect waves-light  ">Batalkan Deliver Kebutuhan</button>
                            </div>
                            @endcan
