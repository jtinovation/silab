...
@section('content')
                            ...
                            <div class="flex-grow-1 overflow-hidden ms-3">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value"
                                            data-target="{{ $jb->barang_data_count }}">0</span></h4>
        ...
        @can('dashboard-lab')
            ...
            @foreach (@$data['laboratorium'] as $lab)
                @php
                    ...
                    $qrMonthly = App\Models\MIjinLBS::where('tm_laboratorium_id', $lab->id)
                ...
                @endphp
                <div class="col-xl-4">
                    <div class="card card-animate laboratorium" data-href="{{ @$is_lab ? route('ijinLBS.index') : '#' }} "
                        data-id="{{ $lab->id }}" style="border-left: 4px rgb(243, 223, 43) solid">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
                                ...
                                <div class="flex-grow-1 overflow-hidden ms-3">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <h4 class="fs-4 flex-grow-1 mb-0"><span class="counter-value"
                                                data-target="{{ $cMonthly }}">0</span></h4>
                                        <span class="badge badge-soft-danger fs-12">
                                            <i class="ri-arrow-right-s-line fs-13 align-middle me-1"></i>
            ...
            @foreach ($data['laboratorium'] as $lab)
                @php
                    $month = \Carbon\Carbon::now()->format('m');
                    $year = \Carbon\Carbon::now()->format('Y');
                    $qrMonthly = App\Models\MHilang::where('tm_laboratorium_id', $lab->id)
                        ->whereYear('created_at', $year)
                        ->whereMonth('created_at', $month)
                        ->get();
                    $cMonthly = count($qrMonthly);
                @endphp
                <div class="col-xl-4">
                    <div class="card card-animate laboratorium" data-href="{{ route('kehilangan.index') }} "
                        data-id="{{ $lab->id }}" style="border-left: 4px rgb(243, 116, 43) solid">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
            ...
            @foreach ($data['laboratorium'] as $lab)
                @php
                    $month = \Carbon\Carbon::now()->format('m');
                    $year = \Carbon\Carbon::now()->format('Y');
                    $qrMonthly = App\Models\MBonalat::where('tm_laboratorium_id', $lab->id)
                        ->whereYear('created_at', $year)
                        ->whereMonth('created_at', $month)
                        ->get();
                    $cMonthly = count($qrMonthly);
                @endphp
                <div class="col-xl-4">
                    <div class="card card-animate laboratorium" data-href="{{ route('bonalat.index') }} "
                        data-id="{{ $lab->id }}" style="border-left: 4px rgb(235, 59, 112) solid">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
            ...
            @foreach ($data['laboratorium'] as $lab)
                @php
                    $month = \Carbon\Carbon::now()->format('m');
                    $year = \Carbon\Carbon::now()->format('Y');
                    $qrMonthly = App\Models\MSerma::where('tm_laboratorium_id', $lab->id)
                        ->whereYear('created_at', $year)
                        ->whereMonth('created_at', $month)
                        ->get();
                    $cMonthly = count($qrMonthly);
                @endphp
                <div class="col-xl-4">
                    <div class="card card-animate laboratorium" data-href="{{ route('serma.index') }} "
                        data-id="{{ $lab->id }}" style="border-left: 4px rgb(27, 226, 93) solid">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
            ...
            @foreach ($data['laboratorium'] as $lab)
                @php
                    $month = \Carbon\Carbon::now()->format('m');
                    $year = \Carbon\Carbon::now()->format('Y');
                    $qrMonthly = App\Models\MKesiapan::where('tm_laboratorium_id', $lab->id)
                        ->whereYear('created_at', $year)
                        ->whereMonth('created_at', $month)
                        ->get();
                    $cMonthly = count($qrMonthly);
                @endphp
                <div class="col-xl-4">
                    <div class="card card-animate laboratorium" data-href="{{ route('kestek.index') }} "
                        data-id="{{ $lab->id }}" style="border-left: 4px rgb(28, 208, 214) solid">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="avatar-sm flex-shrink-0">
                                    <span class="avatar-title bg-soft-primary text-primary rounded-2 fs-2">
    ...
    <script>
        ...
        var id = 0;
        var idDetail = 0;
        var urlTableBarang = "{{ route('getDashboardBarang') }}";;
        var urlDetailBarang = "{{ route('getDashboardDetailBarang') }}";;
        initBarang();
        var options;
    </script>
