...
Route::prefix('silab-jti')->group(function () {
    Route::get('/', function () {
        return redirect()->route('auth.redirect');
    });

    // Login langsung redirect ke Super App
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('getProdi/{id?}', [C_ProgramStudi::class, 'getProdi'])->name('getProdi');
        ...
        Route::get('getMemberLab/{id?}', [C_MemberLab::class, 'getMemberLab'])->name('getMemberLab');
