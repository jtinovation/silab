...
$("body").on("click",".btnEditClassProdi",function(){
    ...
    let tm_program_studi_kode    =currentRow.find("td:eq(0)").text();
    let tm_program_studi_title   =currentRow.find("td:eq(1)").text();
...
$("body").on("click",".delete",function(){
    event.preventDefault();
    var currentRow = $(this).closest("tr");
    let jurusan   =currentRow.find("td:eq(2)").text();
